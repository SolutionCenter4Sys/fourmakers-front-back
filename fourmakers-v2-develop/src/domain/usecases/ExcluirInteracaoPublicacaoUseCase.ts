...
import type { InteracaoPublicacaoResponse } from '@domain/entities/comunicacao';
import type { ComunicacaoFeedRepository } from '@domain/repositories/ComunicacaoFeedRepository';

@injectable()
export class ExcluirInteracaoPublicacaoUseCase {
  constructor(
  ...
  async execute(
    ...
    return this.repository.excluirInteracaoPublicacao(token, payload);
  }
}
