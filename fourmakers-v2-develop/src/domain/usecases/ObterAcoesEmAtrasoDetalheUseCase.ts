...
import type { AcoesEmAtrasoDetalhe } from '@shared/types/dashboardComercialTypes'
import { DiTokens } from '@core/di/tokens'

@injectable()
export class ObterAcoesEmAtrasoDetalheUseCase {
  constructor(
  ...
  async execute(
    ...
    return this.repository.acoesEmAtrasoDetalhe(token, params)
  }
}
