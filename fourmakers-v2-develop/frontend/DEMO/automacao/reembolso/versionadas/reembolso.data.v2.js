...
export const dadosR06 = {
  termoBusca: 'Bradesco',
  descricao: 'Buscar por cliente Bradesco na tabela de reembolsos',
};
...
export const dadosI01 = {
  objetivo: 'Visita técnica ao cliente Itaú em São Paulo',
...
export const dadosI14 = {
  ...
  itens: [
    { valor: '2750', descricao: 'Item 1 — almoço dia 25' },
    { valor: '4320', descricao: 'Item 2 — jantar dia 26' },
    { valor: '3180', descricao: 'Item 3 — almoço dia 27' },
  ],
  totalEsperado: 'R$ 102,50',
};
