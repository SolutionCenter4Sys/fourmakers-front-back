...
- Name: reembolso\versionadas\reembolso-demo-v3.spec.ts >> R-09 [Positivo] Início de nova solicitação
- Location: tests\reembolso\versionadas\reembolso-demo-v3.spec.ts:303:5
...
Locator: getByRole('button', { name: 'Solicitar Reembolso' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Solicitar Reembolso' })
