...
// Cada constante corresponde 1:1 com um cenário do BDD (REEMBOLSO-BDD-v8.md).
 ...
 *  Cada `test()` mapeia 1:1 um cenário do arquivo REEMBOLSO-BDD-v8.md e
...
// ═════════════════════════════════════════════════════════════════════
// Os cenários abaixo existem no BDD v8 + data.js, mas dependem de:
