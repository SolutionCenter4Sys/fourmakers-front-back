...
// Cada constante corresponde 1:1 com um cenário do BDD (REEMBOLSO-BDD-v1.md).
...
} from '../../../../DEMO/automacao/reembolso/versionadas/reembolso.data.v1.js'
 ...
 *  Cada `test()` mapeia 1:1 um cenário do arquivo REEMBOLSO-BDD-v1.md e
 *  usa as constantes geradas pelo DataForge em reembolso.data.v1.js.
 *
 *  INPUTS DA ETAPA 3 (consumidos abaixo):
 *    📄 DEMO/cenarios-bdd/REEMBOLSO-BDD-v1.md     → IDs e nomes dos cenários
 *    📄 DEMO/automacao/reembolso/versionadas/reembolso.data.v1.js → constantes dadosRxx / dadosIxx
...
test.beforeAll(async () => {
  ...
  console.log(`║                                                                  ║`)
  console.log(`║    1️⃣  GherkinFlow → REEMBOLSO-BDD-v1.md (30 cenários)             ║`)
  console.log(`║    2️⃣  DataForge   → reembolso.data.v1.js (30 constantes)          ║`)
  console.log(`║    3️⃣  Playwright  → reembolso-demo-v1.spec.ts (esta spec)         ║`)
  console.log(`║                                                                  ║`)
...
test.afterAll(async () => {
  ...
  console.log(`\n╔${linhaSup}╗`)
  console.log(`║  🎬 DEMO REEMBOLSO v1 — RELATÓRIO FINAL                  ║`)
  console.log(`╠${linhaSup}╣`)
...
// ═════════════════════════════════════════════════════════════════════
// Os cenários abaixo existem no BDD v1 + data.v1.js, mas dependem de:
