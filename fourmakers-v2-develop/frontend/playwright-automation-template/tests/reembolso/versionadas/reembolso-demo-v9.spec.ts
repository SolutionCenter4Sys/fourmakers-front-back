...
// Cada constante corresponde 1:1 com um cenário do BDD (REEMBOLSO-BDD-v9.md).
...
} from '../../../../DEMO/automacao/reembolso/versionadas/reembolso.data.v9.js'
 ...
 *  Cada `test()` mapeia 1:1 um cenário do arquivo REEMBOLSO-BDD-v9.md e
 *  usa as constantes geradas pelo DataForge em reembolso.data.v9.js.
 *
 *  INPUTS DA ETAPA 3 (consumidos abaixo):
 *    📄 DEMO/cenarios-bdd/REEMBOLSO-BDD-v9.md    → IDs e nomes dos cenários
 *    📄 DEMO/automacao/reembolso/versionadas/reembolso.data.v9.js → constantes dadosRxx / dadosIxx
...
// ═════════════════════════════════════════════════════════════════════
// Os cenários abaixo existem no BDD v9 + data.v9.js, mas dependem de:
