...
// Cada constante corresponde 1:1 com um cenário do BDD (REEMBOLSO-BDD-v2.md).
...
} from '../../../../DEMO/automacao/reembolso/versionadas/reembolso.data.v2.js'

/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *  DEMO REEMBOLSO v2 — Jornada E2E (Happy Path + Negativos)
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 *  Esta spec é o output da Etapa 3 (Playwright Agent) da demo pré-vendas.
 *  Cada `test()` mapeia 1:1 um cenário do arquivo REEMBOLSO-BDD-v2.md e
 *  usa as constantes geradas pelo DataForge em reembolso.data.v2.js.
 *
 *  INPUTS DA ETAPA 3 (consumidos abaixo):
 *    📄 DEMO/cenarios-bdd/REEMBOLSO-BDD-v2.md     → IDs e nomes dos cenários
 *    📄 DEMO/automacao/reembolso/versionadas/reembolso.data.v2.js → constantes dadosRxx / dadosIxx
...
test.beforeAll(async () => {
  ...
  console.log(`\n╔${linhaSup}╗`)
  console.log(`║  🎬 DEMO FOURMAKERS — MÓDULO REEMBOLSO (v2)                      ║`)
  ...
  console.log(`║                                                                  ║`)
  console.log(`║    1️⃣  GherkinFlow → REEMBOLSO-BDD-v2.md (30 cenários)             ║`)
  console.log(`║    2️⃣  DataForge   → reembolso.data.v2.js (30 constantes)          ║`)
  console.log(`║    3️⃣  Playwright  → reembolso-demo-v2.spec.ts (esta spec)         ║`)
  console.log(`║                                                                  ║`)
...
test.afterAll(async () => {
  ...
  console.log(`\n╔${linhaSup}╗`)
  console.log(`║  🎬 DEMO REEMBOLSO v2 — RELATÓRIO FINAL                  ║`)
  console.log(`╠${linhaSup}╣`)
...
// ═════════════════════════════════════════════════════════════════════
// Os cenários abaixo existem no BDD v2 + data.v2.js, mas dependem de:
