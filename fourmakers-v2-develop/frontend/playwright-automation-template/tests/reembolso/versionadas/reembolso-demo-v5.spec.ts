...
import { dadosI12, dadosI13 } from '../../../../DEMO/automacao/reembolso/versionadas/reembolso.data.v5.js'
...
test.beforeAll(async () => {
  ...
  LOG.banner('🎬 DEMO REEMBOLSO v5 — ROTEIRO NEGATIVOS RÁPIDOS')
  console.log('📄 BDD     : frontend/DEMO/cenarios-bdd/REEMBOLSO-BDD-v5.md')
  console.log('📄 Massa   : frontend/DEMO/automacao/reembolso/versionadas/reembolso.data.v5.js')
...
test.afterAll(async () => {
  ...
  console.log(`\n╔${linhaSup}╗`)
  console.log(`║  🎬 DEMO REEMBOLSO v5 — RELATÓRIO FINAL                     ║`)
...
test('I-12 [Negativo] Impedir envio com carrinho vazio', async ({ page }) => {
  ...
  // Quando não há itens, o CTA de envio não é renderizado. Validar estado vazio direto.
