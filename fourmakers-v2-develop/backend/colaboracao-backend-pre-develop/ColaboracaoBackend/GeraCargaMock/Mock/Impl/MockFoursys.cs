...
namespace RotinasBackoffice.API.Mock.Impl
{
    ...
    public class MockFoursys : IMockFoursys
    {
        ...
        private KeyValuePair<string, string>[] _diretorias = new KeyValuePair<string, string>[] {
            new KeyValuePair<string, string>("15", "UN I"),
            new KeyValuePair<string, string>("18", "UN II"),
            new KeyValuePair<string, string>("22", "UN VI"),
            new KeyValuePair<string, string>("20", "UN IV")
         };
        ...
        public MockFoursys()
        {
            ...
            int maxGerentes = 100;
            int numberOfProjects = 4000;
            int numberOfColaboradores = 2000;
            ...
            var cargaProjetoFaker = new Faker<ProjetoCargaDTO>("pt_BR")
                ...
                .RuleFor(x => x.Projeto, (f, x) => lorem.Words(2).Aggregate((y, z) => y + " " + z))
            ...
            var cargaGestorFaker = new Faker<ProjetoGerenteCargaDTO>("pt_BR")
                .StrictMode(true)
                .RuleFor(x => x.IdentificadorColaboradorGerente, (f, x) => (f.Random.Number(0, maxGerentes)).ToString())
            ...
            var cargaColaboradorFaker = new Faker<ColaboradorCargaDTO>("pt_BR")
                ...
                .RuleFor(x => x.Email, (f, x) => f.Internet.Email(null,null,"foursys.com.br"))
