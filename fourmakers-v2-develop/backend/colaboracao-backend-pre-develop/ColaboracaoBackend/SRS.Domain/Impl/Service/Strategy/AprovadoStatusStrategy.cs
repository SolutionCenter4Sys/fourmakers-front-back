...
namespace SRS.Domain.Impl.Service.Strategy
{
    ...
    /// </summary>
    public class AprovadoStatusStrategy : MudancaStatusCandidaturaStrategyBase
    {
        ...
        public override bool DeveExecutar(int statusAnteriorId, int novoStatusId, VagaRecrutamentoDTO vaga)
        {
            ...
            if (novoStatusId != StatusCandidaturaRecrutamento.Aprovado.ToInt())
                return false;
