...
namespace SRS.Domain.Impl.Service.Strategy
{
    ...
    /// </summary>
    public class AnaliseGestorStatusStrategy : MudancaStatusCandidaturaStrategyBase
    {
        ...
        public AnaliseGestorStatusStrategy(
        ...
        public override bool DeveExecutar(int statusAnteriorId, int novoStatusId, VagaRecrutamentoDTO vaga)
        {
            ...
            if (novoStatusId != StatusCandidaturaRecrutamento.AnaliseDoCvPeloGestor.ToInt())
                return false;
