...
{
    public class EntrevistaInicialStatusStrategy : MudancaStatusCandidaturaStrategyBase
    {
        private readonly IVagaFourmakersRepository _vagaRepository;

        public EntrevistaInicialStatusStrategy(IVagaFourmakersRepository vagaRepository)
        {
        ...
        public override bool DeveExecutar(int statusAnteriorId, int novoStatusId, VagaRecrutamentoDTO vaga)
        {
            ...
            if (novoStatusId != StatusCandidaturaRecrutamento.EntrevistaInicial.ToInt())
                return false;
