...
namespace SRS.Domain.Impl.Service.Strategy
{
    ...
    /// </summary>
    public class DeclinouStatusStrategy : MudancaStatusCandidaturaStrategyBase
    {
        ...
        public override bool DeveExecutar(int statusAnteriorId, int novoStatusId, VagaRecrutamentoDTO vaga)
        {
            ...
            if (novoStatusId != StatusCandidaturaRecrutamento.Declinou.ToInt())
                return false;
