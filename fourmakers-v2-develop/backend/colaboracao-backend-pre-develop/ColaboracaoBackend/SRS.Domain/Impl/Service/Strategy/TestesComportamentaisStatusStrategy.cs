...
namespace SRS.Domain.Impl.Service.Strategy
{
    ...
    /// </summary>
    public class TestesComportamentaisStatusStrategy : MudancaStatusCandidaturaStrategyBase
    {
        ...
        public TestesComportamentaisStatusStrategy(
        ...
        public override bool DeveExecutar(int statusAnteriorId, int novoStatusId, VagaRecrutamentoDTO vaga)
        {
            ...
            if (novoStatusId != StatusCandidaturaRecrutamento.TestesComportamentais.ToInt())
                return false;
