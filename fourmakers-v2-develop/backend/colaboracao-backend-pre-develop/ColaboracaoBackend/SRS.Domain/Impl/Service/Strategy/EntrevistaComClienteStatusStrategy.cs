...
namespace SRS.Domain.Impl.Service.Strategy
{
    ...
    /// </summary>
    public class EntrevistaComClienteStatusStrategy : MudancaStatusCandidaturaStrategyBase
    {
        ...
        public EntrevistaComClienteStatusStrategy(
        ...
        public override bool DeveExecutar(int statusAnteriorId, int novoStatusId, VagaRecrutamentoDTO vaga)
        {
            ...
            if (novoStatusId != StatusCandidaturaRecrutamento.EntrevistaComGestorDaVaga.ToInt())
                return false;
        ...
        public override async Task<string> ExecutarAsync(MudancaStatusCandidaturaContext context)
        {
            ...
            return $"Vaga sob o codigo {context.Vaga.Codigo} movida para Entrevista com Gestor da Vaga";
        }
    }
}
