-- ------------------------------------------------------------------------------
-- Template de e-mail para notificação de nova comunicação oficial (link para a publicação)
-- Data: 2026-03-05
-- Pasta: scripts/2026/03_Mar/05/15727
-- Placeholders: ${NOME}, ${LINK_PUBLICACAO}
-- ------------------------------------------------------------------------------

INSERT INTO tb_template_email
(id, codigo, descricao, template, ativo, data_alteracao, data_criacao, idioma)
VALUES(
  'a7f1c3e5-b2d4-11ef-9a8b-029c6b897a8d',
  'NOTIFICACAO_COMUNICACAO_OFICIAL',
  'E-mail de notificação de nova comunicação oficial (link para a publicação)',
