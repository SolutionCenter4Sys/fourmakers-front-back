-- ------------------------------------------------------------------------------
-- Template de e-mail NOTIFICACAO_COMUNICACAO_OFICIAL - Inclui titulo e subtitulo no corpo
-- Data: 2026-03-16
-- Pasta: scripts/2026/03_Mar/16/16404
-- Placeholders: ${NOME}, ${LINK_PUBLICACAO}, ${TITULO}, ${SUBTITULO}
-- ------------------------------------------------------------------------------

UPDATE tb_template_email
SET
  descricao = 'E-mail de notificação de nova comunicação oficial (link para a publicação). Placeholders: ${NOME}, ${LINK_PUBLICACAO}, ${TITULO}, ${SUBTITULO}.',
...
<html dir="ltr" lang="pt-BR">
  ...
  <body style="width: 550px; font-family: Arial, sans-serif; -webkit-font-smoothing: antialiased; margin: 0; padding: 0; box-sizing: border-box;">
    ...
    <div style="background-color: #FFF; max-width: 550px; min-height: 200px; padding: 40px;">
      ...
      <p style="margin-top: 12px; font-weight: 600; font-size: 14px; color: #000; line-height: 22px;">${TITULO}</p>
      <p style="font-weight: 400; font-size: 14px; color: #555; line-height: 22px;">${SUBTITULO}</p>
