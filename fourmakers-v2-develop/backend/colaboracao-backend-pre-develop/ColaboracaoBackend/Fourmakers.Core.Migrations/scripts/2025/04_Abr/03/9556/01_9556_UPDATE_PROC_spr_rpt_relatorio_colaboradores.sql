...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
    ...
    CodigoInternoColaborador VARCHAR(36),
    ...
    INSERT INTO tmp_result
        ...
        JOIN
            tb_usuario tu ON tco.codigo_interno_colaborador = tu.codigo_interno_colaborador and tco.tb_org_id = tu.tb_org_id
         LEFT JOIN 
