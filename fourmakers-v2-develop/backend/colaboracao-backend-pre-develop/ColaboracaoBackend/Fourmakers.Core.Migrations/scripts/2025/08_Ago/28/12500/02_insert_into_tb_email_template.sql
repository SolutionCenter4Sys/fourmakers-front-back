...
VALUES(
  ...
  'Template de email para apontamentos excedentes',
  '
  ...
  <body style="width: 550px; font-family: Arial, sans-serif; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; text-rendering: optimizeLegibility; margin: 0; padding: 0; box-sizing: border-box;">
    <table style="width: 100%; height: 134px; background-color: #8C1EE3; table-layout: fixed; border-collapse: collapse;">
      ...
      <div style="background-color: #FFF; max-width: 550px; min-height: 200px; padding: 40px;">
          ...
          <p style="font-weight: 400; font-size: 14px; color: #000; line-height: 22px;">Conforme alerta parametrizado para Org: ${ORG}, seque lista de pessoas que apontaram horas acima do parâmetro de ${HORAS_EXCEDENTES} horas, na vigência de ${MES}/${ANO}.</p>
          <table style=" margin-top: 40px; width: 100%; border-spacing: 0; border-collapse: collapse; font-family: "Inter", sans-serif; box-shadow: 0px 2px 4px -2px #1018280F, 0px 4px 8px -2px #1018281A;">
            <thead>
              <tr style="text-align: left; background-color: #F9FAFB; border-bottom: 1px solid #E1E1E1;">
                <th style="padding: 12px 24px; font-size: 12px; font-weight: 500; color: #47564F;">Colaborador</th>
                <th style="padding: 12px 24px; font-size: 12px; font-weight: 500; color: #47564F; width: 40px;">Pendentes</th>
                <th style="padding: 12px 24px; font-size: 12px; font-weight: 500; color: #47564F; width: 40px;">Aprovadas</th>
                <th style="padding: 12px 24px; font-size: 12px; font-weight: 500; color: #47564F; width: 40px;">Totais</th>
              </tr>
            </thead>
