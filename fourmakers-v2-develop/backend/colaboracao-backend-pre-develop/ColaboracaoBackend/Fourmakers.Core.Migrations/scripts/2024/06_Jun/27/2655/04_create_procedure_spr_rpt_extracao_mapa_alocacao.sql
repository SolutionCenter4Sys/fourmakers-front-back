...
BEGIN
    ...
    FROM 
        ...
        LEFT JOIN tb_colaborador as c ON pa.tb_colaborador_cpf = c.cpf
        LEFT JOIN tb_colaborador_org as co ON co.tb_colaborador_cpf = c.cpf AND pa.tb_org_id = co.tb_org_id
    WHERE
