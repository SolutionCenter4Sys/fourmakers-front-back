...
VIEW `vw_apontamento_mensal` AS
    ...
    FROM
        ...
        GROUP BY tv.mes , tv.ano , tpo.cod_projeto , tca.codigo_interno_colaborador , tc_gerente.codigo_interno_colaborador , tpg.tipo_gerente , tco_gerente.cod_colaborador_externo , tsag.id , tca.tb_org_id) resultado_select
