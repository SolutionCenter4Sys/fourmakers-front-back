...
/// <summary>
/// Registro de log de alteração de Iniciativa, com Objeto e Alteracao deserializados para o front exibir.
/// </summary>
public class VCXIniciativaLogDTO
{
    ...
    public VCXIniciativaDTO? Objeto { get; set; }
    /// <summary>Valor novo (para INSERT/UPDATE).</summary>
    public VCXIniciativaDTO? Alteracao { get; set; }
