...
{
    public class SRSCandidatePostDTO
    {
        public SRSCandidatePostDTO()
        {
            contatoEmergenciaDTO = new List<SRSCandidateContatosEmergenciaDTO>();
        }
        ...
        public sbyte pessoa_refugiada { get; set; }
        ...
        public List<SRSCandidateContatosEmergenciaDTO> contatoEmergenciaDTO { get; set; }
