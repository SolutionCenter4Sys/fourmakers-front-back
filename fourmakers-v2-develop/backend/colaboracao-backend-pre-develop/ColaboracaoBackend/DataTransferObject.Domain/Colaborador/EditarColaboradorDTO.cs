...
namespace DataTransferObject.Domain.Colaborador
{
    public class EditarColaboradorDTO
    {
        ...
        /// <summary>Pretensão salarial da última candidatura do colaborador.</summary>
        public decimal? UltimaPretensaoSalarial { get; set; }
        /// <summary>Id do modelo de trabalho da última candidatura.</summary>
        public string UltimoModeloTrabalhoId { get; set; }
        /// <summary>Descrição do modelo de trabalho da última candidatura.</summary>
