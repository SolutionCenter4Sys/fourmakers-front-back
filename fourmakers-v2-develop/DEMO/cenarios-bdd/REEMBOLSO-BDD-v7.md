...
| R-13 | [Regressivo] Limpeza dos filtros de data | Um colaborador com filtros de data aplicados | aciona o botão "Limpar" nos filtros | os campos Data Início e Data Fim são esvaziados | a tabela volta a exibir todos os reembolsos | `Reembolso.tsx:451 — setDataInicio(undefined)` |
...
| R-15 | [Regressivo] Paginação da tabela | Um colaborador com mais reembolsos do que o limite por página | navega para a próxima página | a tabela exibe o próximo conjunto de registros | é possível alterar a quantidade de itens por página | `Reembolso.tsx:505 — TablePagination` |
...
| I-11 | [Negativo] Anexo em formato não suportado | Um colaborador na seção de comprovantes | anexa um arquivo fora dos formatos aceitos | uma notificação informa que o formato é inválido | o arquivo não é adicionado à lista de comprovantes | `InserirReembolso.tsx:1246 — extensaoParaTipo` |
