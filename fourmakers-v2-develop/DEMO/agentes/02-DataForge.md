...
|---|---|
| `DEMO/cenarios-bdd/REEMBOLSO-BDD-vN.md` | Fonte das regras de negócio |
| `src/presentation/pages/InserirReembolso.tsx` | Campos do formulário real |
| `src/data/api/ReembolsoSolicitacaoApi.ts` | Contratos da API real |
