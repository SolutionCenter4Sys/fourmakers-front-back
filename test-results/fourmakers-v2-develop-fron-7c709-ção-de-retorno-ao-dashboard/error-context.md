...
- Name: fourmakers-v2-develop\frontend\playwright-automation-template\tests\reembolso\versionadas\reembolso-demo-v2.spec.ts >> I-15 [Regressivo] Navegação de retorno ao dashboard
- Location: fourmakers-v2-develop\frontend\playwright-automation-template\tests\reembolso\versionadas\reembolso-demo-v2.spec.ts:467:5
...
Call log:
  - navigating to "/reembolso", waiting until "domcontentloaded"
